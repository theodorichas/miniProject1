...
return [
    ...
    'text-required-phone-minlen' => "Mohon masukan nomor telp yang valid",
    'text-required-address' => "field 'alamat' tidak boleh kosong !!",
    'text-required-email' => "field 'email' tidak boleh kosong!!",
    'text-required-email-min' => "Mohon masukan alamat email yang valid",
    'text-required-password' => "field 'password' tidak boleh kosong!!",
    'text-required-password-min' => "password harus berisikan 8 charactter atau lebih!!",
    'text-required-group-name' => "Mohon pilih salah satu opsi berikut !!",

    //Required -> menu
    'text-required-menu-name' => "field ini tidak boleh kosong!",
    ...
    //user
    'button-add-user' => 'Tambah User',
    'card-title-user' => 'Datatable User',
    'button-add-user-modal' => 'Tambah',
    'button-update-user-modal' => 'Perbaruhi',
    'text-title-user-modal' => 'Tambah User',
    'text-title-update-modal' => 'Perbaharui User',
    'button-status-active' => 'Aktifkan',
    'button-status-de-active' => 'Non aktifkan',
    'text-name' => 'Nama',
    'text-phone' => 'Telp',
    'text-address' => 'Alamat',
    'text-email' => 'Email',
    ...
    //Login alert
    'login-require' => 'Silakan Log-in untuk melihat isi halaman ini',
];
